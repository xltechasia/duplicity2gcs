# Gather system data and ask/confirm with user as required
############################################################
...
if [ -z "$NONINTERACTIVE" ]; then
    ...
    message_box "Mail-in-a-Box Installation" \
        "Hello and thanks for trying $XLT_APPNAME!
        \n\nI'm going to ask you a few questions.
        \n\nTo change your answers later, just run 'sudo $XLT_INSTALLDIR/setup/start.sh' from the command line.
fi
